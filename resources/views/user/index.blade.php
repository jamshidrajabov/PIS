...
@endphp
@extends($layout)
@section('title','Bosh sahifa| User')
@section('page','Bosh sahifa')
@section('content')
            ...
            <div class="box-body">
              ...
              <div class="form-group col-md-6">
                ...
                <div class="input-group">
                  ...
                  <input id="birth" name="birth" required placeholder="2002-06-21"  type="text" class="form-control" autocomplete="off" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask/>
                </div>
              </div>
