@extends('admin.app')
@section('title','Dori qo\'shish')
@section('page','Dori qo\'shish')
        ...
        <div class="col-md-12">
             ...
             <div class="box box-primary">
                <div class="box-header">
                  <h3 class="box-title">Dori qo'shish</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form action="{{route('drug.store')}}" role="form" method="POST">
                    @csrf
                  <div class="box-body">
                    <div class="form-group col-md-6">
                      <label for="name">Dori nomi</label>
                      <input name="name" type="name" class="form-control" id="name" placeholder="Dori nomi" autocomplete="off">
                        @error('name')
